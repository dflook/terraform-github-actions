...
### Fixed
- Automatic masking of the `variables` input in PR comments, for variables that are defined as sensitive only in `.tf.json`/`.tofu.json` files now works correctly.
